...
export default new MLCreate({
  ...
  languages: [
    ...
    new MLanguage('ar').create({
      ...
      teachers: "المدرسين",
      teachers_add: "اضافة المدرسين",
      teachers_edit: "تعديل المدرسين",
      ...
      management_schedule_edit: 'تعديل الجدول',
      is_current: ' التيرم الحالى',
      terms_edit: 'تعديل التيرم ',
      terms_add: 'اضافة التيرم ',
      terms: 'التيرم ',
      management_schedule: ' الجدول',
      role: 'الصلاحية',
      ...
      day: 'اليوم',
      students_notifications_add: 'اضافة اشعار',
      scientific_attachment_add: 'اضافة محتوي علمي',
      scientific_attachment_edit: '  تعديل محتوي علمي',
      ...
      scientific_attachment: 'محتوي علمي',
      add_scientific_attachment: 'اضافة محتوي علمي',
      edit_scientific_attachment: 'تعديل محتوي علمي',
      management_stages_add: ' المراحل الدراسية ',
      management_stages_edit: ' المراحل الدراسية ',
      management_stages: ' المراحل الدراسية ',
      ...
      student_count_term: 'عدد الطلاب بالنسبة للمراحل الدراسية',
      top_absense_students: 'الطلاب الاكثر غيابا',
    })
  ]
})
